  ...
  return ( 
   ...
   {product ? <div>
    <Card className={classes.root} >
           ...
           <CardMedia className={classes.media}  image={`http://localhost:3002/server/uploads/products/${product.image[0].filename}`} title={product.name} onClick={()=>{handleProductOnClick(product._id)}}/>
